...
export function NavigationSidebar({ isOpen, onClose, currentPage, courses = [], onCourseSelect, onAddCourse }: NavigationSidebarProps) {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block fixed top-0 left-0 h-screen w-80 bg-white shadow-xl z-40">
      ...
      <div className={`
        fixed top-0 left-0 h-screen w-80 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out lg:hidden
